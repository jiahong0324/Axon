export const translations = {
  ...
  zh: {
    ...
    'ai.startTask': '开始一个学习任务',
    'ai.title': 'AI 学习助手',
    'ai.subtitle': '随时为您提供解释、计划和学习背景',
    ...
    'auth.guest': '作为访客继续',
    'auth.reset': '重置密码',
    'auth.resetDesc': '输入您的电子邮件以接收重置链接。',
    'auth.guestDesc': '只需输入您的名字即可开始。',
    'auth.welcomeDesc': '您的学习生活，井然有序。',
    'auth.name': '您的名字',
    'auth.namePlaceholder': '我们该怎么称呼您？',
    'auth.continue': '继续',
    'auth.back': '返回登录',
    'auth.fullName': '全名',
    'auth.email': '电子邮件',
    ...
    'auth.termsLink': '条款和条件',
    'auth.or': '或继续使用',
    'auth.lookAround': '只是想看看？',
  }
}
