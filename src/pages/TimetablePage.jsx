      ...
      <div className="mb-6 flex flex-col justify-between gap-3 md:flex-row md:items-center">
        <div className="flex items-center justify-between md:justify-start md:gap-4 w-full md:w-auto">
          ...
          {!loading && classes.length > 0 && (
            <button className="text-red-400 hover:text-red-300 hover:bg-red-500/10 md:border md:border-red-500/20 md:hover:border-red-500/40 p-2 md:p-0 md:h-10 md:w-10 rounded-lg transition-colors flex items-center justify-center gap-2 shrink-0" onClick={clearTimetable} title="Clear Timetable">
